...
@section('admin.css')
    <title>Laravel | New Add User</title>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status_id" class="form-control">
                                                                <option value=""
                                                                        @if(old('status_id') == "") selected @endif>Seç
                                                                </option>
                                                                <option value="1"
                                                                        @if(old('status_id') == 1) selected @endif>Seçilib
                                                                </option>
                                                                <option value="2"
                                                                        @if(old('status_id') == 2) selected @endif>Seçilməyib
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="role" class="form-control">
                                                                <option value=""
                                                                        @if(old('role') == "") selected @endif>Seç
                                                                </option>
