                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        ...
                                                        <img src="{{ \Illuminate\Support\Facades\Storage::url($user->image) }}" alt="profile Pic" height="200" width="200">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status_id" class="form-control">
                                                                <option value=""
                                                                        @if( $user->status_id == "") selected @endif>Seç
                                                                </option>
                                                                <option value="1"
                                                                        @if($user->status_id == 1) selected @endif>Seçilib
                                                                </option>
                                                                <option value="2"
                                                                        @if($user->status_id == 2) selected @endif>Seçilməyib
                                                                </option>
                                                            </select>
                                                            @if ($errors->has('status_id'))
                                                                <span
                                                                    class="text-danger">{{ $errors->first('status_id') }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="role" class="form-control">
                                                                <option value=""
                                                                        @if($user->role == "") selected @endif>Seç
                                                                </option>
                                                                @foreach($roles as $role )
                                                                    <option value="{{ $role->name }}"
                                                                            @if($user->role_id == $role->name) selected @endif>
                                                                        {!! $role->name !!}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password"
                                                                   ...
                                                                   name="password-check" value="{{ old('password-check') }}"
                                                                   placeholder="********">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-8">
